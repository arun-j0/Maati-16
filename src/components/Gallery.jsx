  ...
  return (
    <section className="py-12 bg-[#280101] border-b-4 border-[#fee57e] border-8">
      <div className="container px-4 mx-auto">
        <h2 className="text-4xl md:text-6xl font-bold text-center text-[#fee57e] mb-8">Gallery</h2>
        ...
        <div className="grid grid-cols-1 gap-6 gap-x-2 sm:grid-cols-2 lg:grid-cols-3">

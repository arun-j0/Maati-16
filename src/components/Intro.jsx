    ...
    <section className="py-12 bg-[#280101] border-8 border-b-4 border-[#fee57e]">
      <div className="container px-4 mx-auto">
        <div className="text-center">
          <h1 className="mb-6 text-6xl font-bold text-yellow-300 md:text-8xl">MAATI-16</h1>
          <h2 className="mb-4 text-3xl font-bold text-yellow-300 md:text-6xl">Who We Are</h2>
          ...
          <h3 className="mb-4 text-3xl font-bold text-yellow-300 md:text-6xl">Our Moto</h3>
          <p className="mb-8 text-2xl text-white md:text-4xl">

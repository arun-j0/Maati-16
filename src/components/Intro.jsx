    ...
    <section className="py-12 bg-[#280101] border-8 border-b-4 border-[#fee57e]">
      <div className="container px-4 mx-auto">
        <div className="text-center">
          ...
          <h2 className="mb-4 text-2xl font-bold text-yellow-300 md:text-4xl">Who We Are</h2>
          <p className="mb-8 text-xl text-center text-white md:text-2xl">
          ...
          <a href="#" className="inline-block text-lg md:text-xl px-6 py-3 text-[#280101] transition duration-300 bg-[#fee57e] rounded-md hover:bg-yellow-600">See More</a>
        </div>
      </div>
    </section>
  );

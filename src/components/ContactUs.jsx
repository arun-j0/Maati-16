  ...
  return (
    <section className="py-12 bg-[#280101] border-b-4 border-[#fee57e] border-8">
      <div className="container mx-auto">
        <h2 className="text-6xl md:text-8xl font-bold text-center text-[#fee57e] mb-8">Contact Us</h2>
        <form className="flex flex-col max-w-sm mx-auto md:max-w-lg">
          <div className="flex flex-col mb-6">
            <label htmlFor="name" className="mb-2 text-[#fee57e] text-2xl md:text-4xl">Name</label>
          ...
          <div className="flex flex-col mb-6">
            <label htmlFor="email" className="mb-2 text-[#fee57e]  text-2xl md:text-4xl">Email</label>
          ...
          <div className="flex flex-col mb-6">
            <label htmlFor="message" className="mb-2 text-[#fee57e]  text-2xl md:text-4xl">Message</label>

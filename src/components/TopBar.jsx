    ...
    <div className="pt-2 bg-white">
      <div className="container flex items-center justify-between mx-auto">
        ...
        <div className="flex items-center pr-2">
          ...
          <a href="https://www.instagram.com/maati16._?igsh=MWt1Y2Y3cThzem5xaQ==" className="mr-4 text-amber-900 hover:text-[#fee57e]" target="_blank" rel="noopener noreferrer">

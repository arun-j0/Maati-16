  ...
  return (
    <section className="py-12 bg-[#280101] border-8 border-b-4 border-[#fee57e]">
      <div className="container px-4 mx-auto">
        <h2 className="mb-8 text-4xl font-bold text-center text-[#fee57e] md:text-6xl">How You Can Help</h2>
        <div className="flex flex-col justify-center gap-4 md:flex-row">
          ...
          <Tilt className="flex flex-col items-center flex-1 p-6 bg-white rounded-lg shadow-md">
            ...
            <p className="mb-6 text-lg text-center text-black md:text-2xl">Your donation can make a big difference. Support our cause and help those in need.</p>
          ...
          <Tilt className="flex flex-col items-center flex-1 p-6 bg-white rounded-lg shadow-md">
            ...
            <p className="mb-6 text-lg text-center text-black md:text-2xl">Join us in our mission. Volunteer your time and skills to make a positive impact in our community.</p>
          ...
          <Tilt className="flex flex-col items-center flex-1 p-6 bg-white rounded-lg shadow-md">
            ...
            <p className="mb-6 text-lg text-center text-black md:text-2xl">There are many ways to get involved. Learn more about our initiatives and join our community.</p>
